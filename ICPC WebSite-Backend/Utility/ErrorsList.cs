...
namespace ICPC_WebSite_Backend.Utility
{
    public class ErrorsList
    {
        ...
        // training
        public static Error TrainingNotFound = new Error { Code = "TrainingNotFound", Description = "training not exists" };
        public static Error InvalidTrainingTitle = new Error { Code = "InvalidTrainingTiltle", Description = "invalid title for this Training" };
